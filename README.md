...
From the above observations, we can say that the front part of spectral components in the KLT coefficient matrix accounts for the reconstruction of image macro-structures such as the basic contour and main structures while the latter part of spectral components accounts for the reconstruction of image microstructures such as the small textures and details.
